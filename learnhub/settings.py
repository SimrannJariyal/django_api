...
SECRET_KEY = 'django-insecure-t6^ng=^9-!bl(qa(9jyx-^-_^5$pk*-fay7zz*v8akd_juppa!'
...
# CORS settings for allowing access from your Android app
CORS_ALLOWED_ORIGINS = [
    'http://localhost:3000',  # or your Android app IP
]
